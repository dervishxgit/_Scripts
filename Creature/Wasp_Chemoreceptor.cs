...
public class Wasp_Chemoreceptor : MonoBehaviour
{
	 ...
	 * 
	 * TODO: need to change this so that it updates the wasp core properly without conflicts
	 */
	...
	void OnTriggerEnter (Collider other)
	{
		...
		Debug.Log("called trigger enter even when spawning inside");
	}
